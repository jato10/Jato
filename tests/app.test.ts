...
describe('Jato SuperApp Core System Tests', () => {
  ...
  describe('Venezuelan Payment Processor', () => {
    ...
    test('Card/digital wallet payment processing', () => {
      const res = paymentProcessor.processCardPayment({
        rideId: 'ride_7712a',
        amount: 4.50,
        currency: 'USD',
        paymentMethod: 'CREDIT_CARD',
        paymentToken: 'tok_1N3c123',
      ...
      expect(() => paymentProcessor.processCardPayment({
        rideId: 'ride_7712a',
        amount: 0,
        currency: 'USD',
        paymentMethod: 'CREDIT_CARD',
      ...
      })).toThrow('Monto de pago debe ser mayor a 0');
      ...
      expect(() => paymentProcessor.processCardPayment({
        ...
        paymentToken: '',
        isInternational: false
      })).toThrow('Token de pago inválido');
    });
